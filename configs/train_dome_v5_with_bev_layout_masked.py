...
multisteplr_config = dict(
    ...
    warmup_t=0)
optimizer = dict(optimizer=dict(lr=0.0002, type='AdamW', weight_decay=0.0001))
...
train_loader = dict(batch_size=32, num_workers=1, shuffle=True)
