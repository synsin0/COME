...
stage_one_config = "configs/unet/unet_aligned_past0.5s_future_3s.py"
stage_one_ckpt = "work_dirs/unet/unet_aligned_past0.5s_future_3s/default/best.pth"

world_model_config = "configs/train_dome_v5_with_bev_layout_masked.py"
world_model_ckpt = "work_dir/train_dome_v3_with_bev_layout/best_miou.pth"
...
train_dataset_config = dict(
    ...
    with_bev_layout=True,
    bev_root='data/step2/train/bevmap_4'
)
...
val_dataset_config = dict(
    ...
    type='nuScenesSceneDatasetLidar',
    with_bev_layout=True,
    bev_root='data/step2/val/bevmap_4'
)
